    ...
    <footer className="bg-gray-50 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">{companyMetadata.companyName}</h3>
            <p className="text-sm text-gray-600">
              Professional electronic solutions and services for your business needs.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href={`mailto:${companyMetadata.email}`}
        ...
        <div className="border-t border-gray-200 pt-8">
          <p className="text-center text-sm text-gray-600">
            © {currentYear} {companyMetadata.companyName}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
